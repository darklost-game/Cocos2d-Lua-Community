...
static int lua_fairygui_UIPackage_SetStringsSource(lua_State* tolua_S)
{
    int argc = 0;
    bool ok = true;
    ...
    if (argc == 1) {
        std::string arg0;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0, "fairygui.UIPackage:SetStringsSource");
        if (!ok) {
            tolua_error(tolua_S, "invalid arguments in function 'lua_fairygui_UIPackage_SetStringsSource'", nullptr);
            return 0;
        }
        fairygui::UIPackage::SetStringsSource(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "fairygui.UIPackage:SetStringsSource", argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_fairygui_UIPackage_SetStringsSource'.", &tolua_err);
    return 0;
#endif
}
...
static int lua_register_fairygui_UIPackage(lua_State* tolua_S)
{
    ...
    tolua_function(tolua_S, "SetStringsSource", lua_fairygui_UIPackage_SetStringsSource);
...
static int lua_fairygui_GComboBox_addValue(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok = true;
...
#if COCOS2D_DEBUG >= 1
    if (!cobj) {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_fairygui_GComboBox_addValue'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) {
        std::string arg0;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0, "fairygui.GComboBox:addValue");
        if (!ok) {
            tolua_error(tolua_S, "invalid arguments in function 'lua_fairygui_GComboBox_addValue'", nullptr);
            return 0;
        }
        cobj->addValue(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fairygui.GComboBox:addValue", argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_fairygui_GComboBox_addValue'.", &tolua_err);
    return 0;
#endif
}


static int lua_fairygui_GComboBox_addItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok = true;
...
#if COCOS2D_DEBUG >= 1
    if (!cobj) {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_fairygui_GComboBox_addItem'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) {
        std::string arg0;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0, "fairygui.GComboBox:addItem");
        if (!ok) {
            tolua_error(tolua_S, "invalid arguments in function 'lua_fairygui_GComboBox_addItem'", nullptr);
            return 0;
        }
        cobj->addItem(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fairygui.GComboBox:addItem", argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_fairygui_GComboBox_addItem'.", &tolua_err);
    return 0;
#endif
}


static int lua_fairygui_GComboBox_addIcon(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok = true;
...
#if COCOS2D_DEBUG >= 1
    if (!cobj) {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_fairygui_GComboBox_addIcon'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) {
        std::string arg0;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0, "fairygui.GComboBox:addIcon");
        if (!ok) {
            tolua_error(tolua_S, "invalid arguments in function 'lua_fairygui_GComboBox_addIcon'", nullptr);
            return 0;
        }
        cobj->addIcon(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fairygui.GComboBox:addIcon", argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_fairygui_GComboBox_addIcon'.", &tolua_err);
    return 0;
#endif
}
...
static int lua_register_fairygui_GComboBox(lua_State* tolua_S)
{
    ...
    tolua_function(tolua_S,"addValue",lua_fairygui_GComboBox_addValue);
    tolua_function(tolua_S,"addItem",lua_fairygui_GComboBox_addItem);
    tolua_function(tolua_S,"addIcon",lua_fairygui_GComboBox_addIcon);
